...
export class UserprofileComponent {
  ...
  getAllApplications(){
    this.userService.getAllApplications().subscribe((applicationList)=>{
      this.currentApplication = applicationList[applicationList.length-1];
  ...
  changeStatus(){
    this.status= `Your application is submitted successfully! And your application no. is ${this.currentApplication.id}`
